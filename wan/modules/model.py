...
import os
from .attention import flash_attention, _save_attn_png
...
class WanT2VCrossAttention(WanSelfAttention):
    ...
    def forward(self, x, context, context_lens, crossattn_cache=None, debug_dict=None):
        r"""
        Args:
        ...
        if debug_dict is not None and debug_dict["block_index"] ==0 and debug_dict['visualize_attention']:
            ...
            save_path = debug_dict.get("save_path", f"./visual-output/cross-attn-{debug_dict['current_chunk']}-{debug_dict['current_step']}.npy")
            ...
            print(f"[Debug] Saved cross-attention map to {save_path}, shape={attn.shape}")
